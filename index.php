...
<title>HỆ THỐNG QUẢN LÝ KHÁCH HÀNG DÀNH CHO CỘNG TÁC VIÊN</title>
...
$(document).ready(function(e) {
    ...
    $('#logindealer_frm').submit(function(e) {
		try {
			...
			$.ajax({
				type: "POST",
				url: "/control/AjaxLoginDealer.php",
				...
				success: function(response){
					if(response == "true") {
					...
					} else if(response == "acti") { 
						/*new Messi('Tài khoản của bạn chưa được chúng tôi kích hoạt!', {
							title: 'Đăng Nhập',
						...
						alert("Tài khoản của bạn chưa được chúng tôi kích hoạt!");
						$('#From_Email').select();
						...
						alert("Tài khoản của bạn đã bị khóa vui lòng liên hệ với chúng tôi để được kích hoạt lại!");
						$('#From_Email').select();
					} else {
	...
	<div class="text11" style="color:#4c4c4c; width:950px; margin-left:20px; margin-top:10px;">
    	<div style="width: 458px; position: relative; margin: auto;">
        	<div class="fShowLoginSuccess" style="display: none;">
                <div style="position: absolute; width: 448px; height: 240px; top: 18px; left: 5px; background: #CCC; opacity: 0.5; border-radius: 15px; z-index: 2;"></div>
                <div style="width: 458px; position: absolute; height: 240px; top: 18px; left: 5px; z-index: 3;">
            ...
            <form id="logindealer_frm" name="logindealer_frm" method="post" action="">
                <table width="458" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td height="74" valign="middle" align="center" background="/images/apl-tp.gif" style="background-repeat:no-repeat;"><h1>ĐĂNG NHẬP</h1></td>
                    </tr>
                    <tr>
                        <td class="aplfrm"><table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tbody>
                                ...
                                <tr>
                                    <td width="30%" height="35" class="frmtxt" valign="center">Mật khẩu <span class="showms">*</span></td>
                                ...
                                <tr>
                                    <td height="35" colspan="2" align="center"><a href="#" onclick="alert('Vui lòng liên hệ với chúng tôi để được reset mật khẩu.');">Quên mật khẩu</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/dang-ky-dai-ly.html">Đăng ký</a></td>
                                </tr>
                                <tr>
                                    <td colspan="2" align="center"><font><input name="submit" type="submit" class="btnclr" value="Đăng nhập" style="width: 90px;"></font></td>
                                </tr>
                            </tbody>
                        </table></td>
                    </tr>
